...
const REQUIRED_CI_ARTIFACT_EVIDENCE = Object.freeze({
  HOSTED_MACOS_FAILURE_ARTIFACT_NAME: "macos14-arm64-foundation-failure-evidence",
  HOSTED_MACOS_FAILURE_ARTIFACT_STATUS: "NOT_PRODUCED",
...
const TARGET_EVIDENCE_SCHEMA = Object.freeze({
  HOSTED_MACOS_FAILURE_ARTIFACT_NAME: Object.freeze([
    REQUIRED_CI_ARTIFACT_EVIDENCE.HOSTED_MACOS_FAILURE_ARTIFACT_NAME,
  ]),
  HOSTED_MACOS_FAILURE_ARTIFACT_STATUS: Object.freeze([
    REQUIRED_CI_ARTIFACT_EVIDENCE.HOSTED_MACOS_FAILURE_ARTIFACT_STATUS,
  ]),
  ...
  WINDOWS11_FOUNDATION_ARTIFACT_NAME: Object.freeze([
    REQUIRED_CI_ARTIFACT_EVIDENCE.WINDOWS11_FOUNDATION_ARTIFACT_NAME,
  ]),
  ...
  WINDOWS_SERVER_SMOKE_ARTIFACT_NAME: Object.freeze([
    REQUIRED_CI_ARTIFACT_EVIDENCE.WINDOWS_SERVER_SMOKE_ARTIFACT_NAME,
  ]),
