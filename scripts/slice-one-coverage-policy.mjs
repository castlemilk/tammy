...
export const SLICE_ONE_RPC_POLICY = {
  ...
  "tammy.v1.CompanyTaxService.SetCompanyTaxProfile": rpc({
    ...
    failures: [
      ...
      "FACTOR_ASSERTION_REQUIRED",
      "FACTOR_ASSERTION_STALE",
      "UNSUPPORTED_COMPANY_SCENARIO",
    ],
  }),
  "tammy.v1.CompanyTaxService.CreateCompanyReturn": rpc({
    name: "CreateCompanyReturn",
    route: "/eofy-company-tax/return",
    rolePolicy: adminAndPreparer,
    mode: "persistent_command",
    failures: [
  ...
  "tammy.v1.CompanyTaxService.ListCompanyReturnFacts": rpc({
    name: "ListCompanyReturnFacts",
    route: "/eofy-company-tax/return",
    rolePolicy: accountingRead,
    mode: "query",
    failures: [...authenticated, "NOT_FOUND", "INVALID_CURSOR"],
    list: ["empty", "populated", "paginated"],
  }),
  "tammy.v1.CompanyTaxService.SetCompanyReturnInput": rpc({
    name: "SetCompanyReturnInput",
    route: "/eofy-company-tax/return",
    rolePolicy: adminAndPreparer,
    mode: "persistent_command",
    failures: [
  ...
  "tammy.v1.CompanyTaxService.RemoveTaxAdjustment": rpc({
    name: "RemoveTaxAdjustment",
    route: "/eofy-company-tax/return",
    rolePolicy: adminAndPreparer,
    mode: "persistent_command",
    failures: [...roleGuardedStalePersistent, "NOT_FOUND", "INVALID_STATE_TRANSITION"],
  }),
  "tammy.v1.CompanyTaxService.UpsertTaxElection": rpc({
    name: "UpsertTaxElection",
    route: "/eofy-company-tax/return",
    rolePolicy: adminAndPreparer,
    mode: "persistent_command",
    failures: [
  ...
  "tammy.v1.CompanyTaxService.WithdrawCompanyReturnDeclaration": rpc({
    name: "WithdrawCompanyReturnDeclaration",
    route: "/eofy-company-tax/return",
    rolePolicy: lodger,
    mode: "persistent_command",
    failures: [
  ...
  "tammy.v1.CompanyTaxService.CreateCompanyReturnReplacement": rpc({
    name: "CreateCompanyReturnReplacement",
    route: "/eofy-company-tax/return",
    rolePolicy: adminAndPreparer,
    mode: "persistent_command",
    failures: [
  ...
  "tammy.v1.CompanyTaxService.CreateCompanyReturnAmendment": rpc({
    name: "CreateCompanyReturnAmendment",
    route: "/eofy-company-tax/return",
    rolePolicy: adminAndPreparer,
    mode: "persistent_command",
    failures: [
      ...roleGuardedStalePersistent,
      "AMENDMENT_REQUIRED",
      "SUBSEQUENT_AMENDMENT_UNSUPPORTED",
      "LODGE_OUTCOME_UNKNOWN",
      "SOURCE_CLOSE_STALE",
      "INVALID_STATE_TRANSITION",
    ],
  ...
  "tammy.v1.CompanyReturnSubmissionService.PreLodgeCompanyReturn": rpc({
    name: "PreLodgeCompanyReturn",
    route: "/eofy-company-tax/lodge",
    rolePolicy: lodger,
    mode: "persistent_command",
    failures: [
      ...roleGuardedStalePersistent,
      ...
      "SOURCE_CLOSE_STALE",
      "REPORT_BUNDLE_UNAVAILABLE",
      "SBR_CREDENTIAL_NOT_READY",
      "SBR_PRODUCT_SERVICE_NOT_READY",
      "PRELODGE_OUTCOME_UNKNOWN",
    ],
  }),
  "tammy.v1.CompanyReturnSubmissionService.LodgeCompanyReturn": rpc({
    name: "LodgeCompanyReturn",
    route: "/eofy-company-tax/lodge",
    rolePolicy: lodger,
    mode: "persistent_command",
    failures: [
      ...
      "FACTOR_ASSERTION_STALE",
      "DECLARATION_REQUIRED",
      "PRELODGE_REVIEW_REQUIRED",
      "PRELODGE_OUTCOME_UNKNOWN",
      "REPORT_BUNDLE_UNAVAILABLE",
      "SBR_CREDENTIAL_NOT_READY",
      "SBR_PRODUCT_SERVICE_NOT_READY",
      "ATO_VALIDATION_FAILED",
      "LODGE_OUTCOME_UNKNOWN",
    ],
  }),
  "tammy.v1.CompanyReturnSubmissionService.GetCompanyReturnSubmission": rpc({
    name: "GetCompanyReturnSubmission",
    route: "/eofy-company-tax/lodge",
    rolePolicy: accountingRead,
    mode: "query",
    failures: [...authenticated, "NOT_FOUND"],
  ...
  "tammy.v1.CompanyReturnSubmissionService.RefreshCompanyReturnStatus": rpc({
    name: "RefreshCompanyReturnStatus",
    route: "/eofy-company-tax/lodge",
    rolePolicy: lodger,
    mode: "persistent_command",
    failures: [
  ...
  "tammy.v1.CompanyReturnSubmissionService.ReconcileUnknownCompanyReturnSubmission": rpc({
    name: "ReconcileUnknownCompanyReturnSubmission",
    route: "/eofy-company-tax/lodge",
    rolePolicy: lodger,
    mode: "persistent_command",
    failures: [
